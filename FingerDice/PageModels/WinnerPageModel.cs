...
{
    public partial class WinnerPageModel : ObservableObject, IQueryAttributable
    {
        ...
        public WinnerPageModel(ProjectRepository projectRepository, TaskRepository taskRepository, ModalErrorHandler errorHandler)
        {
