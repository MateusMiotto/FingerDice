...
{
    public partial class GroupPageModel : ObservableObject, IQueryAttributable
    {
        ...
        public GroupPageModel(ProjectRepository projectRepository, TaskRepository taskRepository, ModalErrorHandler errorHandler)
        {
